...
namespace CryptoMarketClient.HitBtc {
    public class HitBtcTicker : TickerBase {
        ...
        protected HitBtcBalanceInfo BaseCurrencyBalanceInfo {
            get {
                if(firstInfo == null)
        ...
        protected HitBtcBalanceInfo MarketCurrencyBalanceInfo {
            get {
                if(secondInfo == null)
        ...
        public override decimal BaseCurrencyBalance {
            get { return BaseCurrencyBalanceInfo == null ? 0 : BaseCurrencyBalanceInfo.Available; }
        }

        public override decimal MarketCurrencyTotalBalance {
            get { return MarketCurrencyBalanceInfo == null ? 0 : MarketCurrencyBalanceInfo.Available; }
        }
