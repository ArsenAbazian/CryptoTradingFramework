...
namespace Crypto.Core.Arbitrages.Dependency {
    public partial class DependencyArbitrageChartForm : XtraForm {
        ...
        DependencyArbitrageInfo arbitrage;
        public DependencyArbitrageInfo Arbitrage {
            get { return arbitrage; }
            set {
                if(Arbitrage == value)
                    return;
                DependencyArbitrageInfo prev = Arbitrage;
                arbitrage = value;
        ...
        void OnArbitrageChanged(DependencyArbitrageInfo prev, DependencyArbitrageInfo current) {
            if(prev != null)
                prev.Tag = null;
