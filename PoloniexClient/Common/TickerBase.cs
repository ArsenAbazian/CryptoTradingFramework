...
namespace CryptoMarketClient {
    public abstract class TickerBase : IXtraSerializable {
        ...
        public TickerUpdateMode UpdateMode { get; set; }
        ...
        protected string FileName { get { return Exchange.TickersDirectory + "\\" + Name.ToLower() + ".xml"; } }
        protected SnapshotChartControl BidAskChart { get { return this.bidAskChart ?? (this.bidAskChart = CreateChartSnapshotControl()); } }
        protected SnapshotChartControl OrderBookChart { get { return this.orderBookChart ?? (this.orderBookChart = CreateOrderBookChartControl()); } }
        ...
        Image BidAskSnapshot { get { return this.bidAskSnapshot ?? (this.bidAskSnapshot = CreateChartSnapshotImage()); } }
        Image OrderBookSnapshot { get { return this.orderBookSnapshot ?? (this.orderBookSnapshot = CreateOrderBookSnapshotImage()); } }
